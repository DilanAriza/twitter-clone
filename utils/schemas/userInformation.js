...
const phoneNumberUserInformationSchema = Joi.number().max(18).required();
...
const countryUserInformationSchema = Joi.string().required().default('Narnia');
...
const ageUserInformationSchema = Joi.number().default(18).required();
